        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={projectMenuRef}>
            ...
            >
              ...
              <h1 className="text-sm font-semibold text-gray-900">Biofincas</h1>
              <ChevronDown 
                size={14} 
            ...
            {isProjectMenuOpen && (
              <div className="absolute left-0 mt-2 w-64 bg-white rounded-2xl shadow-lg border border-gray-200 py-2 z-50">
                ...
                {/* DigiDeeFree */}
                <a
                  href="https://digideefreemonitorv5.vercel.app/"
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <p className="font-semibold text-gray-900">DigiDeeFree</p>
